...
class ModelTrainer:
    ...
    def initiate_model_training(self, train_array, test_array):
        try:
            logging.info('Splittinng dependent and independent varibale from train and test data')
            ...
            logging.info('Best Model Score Achieved')
            ...
            logging.info('Best Model Name Achieved')
